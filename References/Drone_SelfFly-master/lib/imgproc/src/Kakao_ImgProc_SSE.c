...
static void _GetMean4x4_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetMean8x8_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetMean16x16_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetVar4x4_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetVar8x8_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetVar16x16_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetDiffVar4x4_SSE(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetDiffVar8x8_SSE(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetDiffVar16x16_SSE(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetMean_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nWidth, IN const INT32 nHeight,
                             OUT UINT32 *pSum, fpgetNxMMean fpMean, IN const INT32 nBlockSize);
static void _GetVariance_SSE(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0, IN const INT32 nWidth, IN const INT32 nHeight,
                             OUT UINT32 *pSqSum, OUT UINT32 *pSum, fpgetNxMVar fpVar, IN const INT32 nBlockSize);
static void _GetDiffVariance_SSE(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0, IN const UINT8 *pSrc1, IN const INT32 nSrcStride1,
...
static void _GetMean4x4_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetMean8x8_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetMean16x16_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSum);
static void _GetVar4x4_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetVar8x8_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetVar16x16_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, OUT UINT32 *pSqSum, OUT UINT32 *pSum);
static void _GetDiffVar4x4_MMX(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetDiffVar8x8_MMX(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetDiffVar16x16_MMX(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0,
                             IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum);
static void _GetMean_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nWidth, IN const INT32 nHeight,
                         OUT UINT32 *pSum, fpgetNxMMean fpMean, IN const INT32 nBlockSize);
static void _GetVariance_MMX(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0, IN const INT32 nWidth, IN const INT32 nHeight,
                             OUT UINT32 *pSqSum, OUT UINT32 *pSum, fpgetNxMVar fpVar, IN const INT32 nBlockSize);
static void _GetDiffVariance_MMX(IN const UINT8 *pSrc0, IN const INT32 nSrcStride0, IN const UINT8 *pSrc1, IN const INT32 nSrcStride1,
                             IN const INT32 nWidth, IN const INT32 nHeight, OUT UINT32 *pSqSum, OUT INT32 *pSum,
                             fpgetNxMDiffVar fpVar, IN const INT32 nBlockSize);
#endif
...
void OneRow_MeanBlur_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
...
void OneRow_MeanBlur_Ver_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
...
void OneRow_Mosaic4_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
...
void OneRow_Mosaic8_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
...
void OneRow_Mosaic16_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
...
void OneRow_Clip_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nMinClipVal, IN const INT32 nMaxClipVal)
{
    INT32                   i = 0;
...
void OneRow_BlurNoiseReduction_SSE(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
    UINT8                   *pSrcPrev = NULL, *pSrcNext0 = NULL, *pSrcNext1 = NULL, *pSrcNext2 = NULL;
    UINT8                   *pDst0 = NULL, *pDst1 = NULL, *pDst2 = NULL;
                               ...
                               IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum)
{
    ...
    for(i=0 ; i<4 ; i++)
    {
        const INT32         nDiff0 = pSrc0[0] - pSrc1[0];
        const INT32         nDiff1 = pSrc0[1] - pSrc1[1];
        const INT32         nDiff2 = pSrc0[2] - pSrc1[2];
        const INT32         nDiff3 = pSrc0[3] - pSrc1[3];
                               ...
                               IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum)
{
    ...
    for(i=0 ; i<4 ; i++)
    {
        ...
        const INT32         nDiff2 = pSrc0[2] - pSrc1[2];
        const INT32         nDiff3 = pSrc0[3] - pSrc1[3];
        const INT32         nDiff4 = pSrc0[4] - pSrc1[4];
        const INT32         nDiff5 = pSrc0[5] - pSrc1[5];
        const INT32         nDiff6 = pSrc0[6] - pSrc1[6];
        const INT32         nDiff7 = pSrc0[7] - pSrc1[7];
                               ...
                               IN const UINT8 *pSrc1, IN const INT32 nSrcStride1, OUT UINT32 *pSqSum, OUT INT32 *pSum)
{
    ...
    for(j=0 ; j<16 ; j++)
    {
        ...
        for(i=0 ; i<2 ; i++)
        {
            const INT32     nDiff0 = pLocalSrc0[0] - pLocalSrc1[0];
            const INT32     nDiff1 = pLocalSrc0[1] - pLocalSrc1[1];
            const INT32     nDiff2 = pLocalSrc0[2] - pLocalSrc1[2];
            const INT32     nDiff3 = pLocalSrc0[3] - pLocalSrc1[3];
            const INT32     nDiff4 = pLocalSrc0[4] - pLocalSrc1[4];
            const INT32     nDiff5 = pLocalSrc0[5] - pLocalSrc1[5];
            const INT32     nDiff6 = pLocalSrc0[6] - pLocalSrc1[6];
            const INT32     nDiff7 = pLocalSrc0[7] - pLocalSrc1[7];
...
static void _GetVariance_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nWidth, IN const INT32 nHeight,
                             OUT UINT32 *pSqSum, OUT UINT32 *pSum, fpgetNxMVar fpVar, IN const INT32 nBlockSize)
{
    INT32                   i = 0, j = 0;
...
F32 Mean_MxN_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSum)
{
    ...
    if(16 == nPatchSize)
        _GetMean4x4_SSE(pSrc, nSrcStride, &nLocalSum);
    else if(32 == nPatchSize)
        _GetMean_SSE(pSrc, nSrcStride, nSizeX, nSizeY, &nLocalSum, _GetMean4x4_SSE, 4);
    else if(64 == nPatchSize)
        _GetMean8x8_SSE(pSrc, nSrcStride, &nLocalSum);
    else if(128 == nPatchSize)
        _GetMean_SSE(pSrc, nSrcStride, nSizeX, nSizeY, &nLocalSum, _GetMean8x8_SSE, 8);
    else if(256 == nPatchSize)
        _GetMean16x16_SSE(pSrc, nSrcStride, &nLocalSum);
...
F32 Variance_MxN_SSE(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSqSum, OUT UINT32 *pSum)
{
    const INT32             nPatchSize = nSizeX * nSizeY;
    UINT32                  nLocalSum = 0;
    
    if(16 == nPatchSize)
        _GetVar4x4_SSE(pSrc, nSrcStride, pSqSum, &nLocalSum);
    else if(32 == nPatchSize)
        _GetVariance_SSE(pSrc, nSrcStride, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetVar4x4_SSE, 4);
    else if(64 == nPatchSize)
        _GetVar8x8_SSE(pSrc, nSrcStride, pSqSum, &nLocalSum);
    else if(128 == nPatchSize)
        _GetVariance_SSE(pSrc, nSrcStride, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetVar8x8_SSE, 8);
    else if(256 == nPatchSize)
        _GetVar16x16_SSE(pSrc, nSrcStride, pSqSum, &nLocalSum);
                          ...
                          IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSqSum, OUT INT32 *pSum)
{
    ...
    if(16 == nPatchSize)
        _GetDiffVar4x4_SSE(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
    else if(32 == nPatchSize)
        _GetDiffVariance_SSE(pSrc0, nSrcStride0, pSrc1, nSrcStride1, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetDiffVar4x4_SSE, 4);
    else if(64 == nPatchSize)
        _GetDiffVar8x8_SSE(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
    else if(128 == nPatchSize)
        _GetDiffVariance_SSE(pSrc0, nSrcStride0, pSrc1, nSrcStride1, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetDiffVar8x8_SSE, 8);
    else if(256 == nPatchSize)
        _GetDiffVar16x16_SSE(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
...
void Erosion_MMX(IN const Filter_T *pFilter, IN const Img_T *pSrcImg, OUT Img_T *pDstImg, IN const BinaryMapType nBinaryMap, IN const INT32 nThick)
{
    INT32                   i = 0, j = 0;
...
void Dilation_MMX(IN const Filter_T *pFilter, IN const Img_T *pSrcImg, OUT Img_T *pDstImg, IN const BinaryMapType nBinaryMap)
{
    INT32                   i = 0, j = 0;
    INT32                   nLocalPos = 0, nInPos = 0;
...
void OneRow_MeanBlur_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
    UINT8                   *pSrcPrev = NULL, *pSrcNext0 = NULL, *pSrcNext1 = NULL, *pSrcNext2 = NULL;
    UINT8                   *pDst0 = NULL, *pDst1 = NULL, *pDst2 = NULL;
...
void OneRow_MeanBlur_Ver_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
    UINT8                   *pSrcPrev = NULL, *pSrcNext = NULL;
...
void OneRow_Mosaic4_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
    UINT32                  nMosaicSize = 4;
    INT32                   nLocalPos = 0;
...
void OneRow_Mosaic8_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
    UINT32                  nMosaicSize = 8;
    INT32                   nLocalPos = 0;
...
void OneRow_Mosaic16_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride, IN const RectImgAddr *pBaseRectAddr)
{
    INT32                   i = 0, j = 0;
    UINT32                  nMosaicSize = 16;
    INT32                   nLocalPos = 0;
...
void OneRow_Clip_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nMinClipVal, IN const INT32 nMaxClipVal)
{
    INT32                   i = 0;
...
void OneRow_BlurNoiseReduction_MMX(IN const UINT8 *pSrc, OUT UINT8 *pDst, IN const INT32 nWidth, IN const INT32 nSrcStride, IN const INT32 nDstStride)
{
    INT32                   i = 0;
    UINT8                   *pSrcPrev = NULL, *pSrcNext0 = NULL, *pSrcNext1 = NULL, *pSrcNext2 = NULL;
    UINT8                   *pDst0 = NULL, *pDst1 = NULL, *pDst2 = NULL;
...
static void _GetVariance_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nWidth, IN const INT32 nHeight,
                             OUT UINT32 *pSqSum, OUT UINT32 *pSum, fpgetNxMVar fpVar, IN const INT32 nBlockSize)
{
    INT32                   i = 0, j = 0;
...
F32 Mean_MxN_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSum)
{
    ...
    if(16 == nPatchSize)
        _GetMean4x4_MMX(pSrc, nSrcStride, &nLocalSum);
    else if(32 == nPatchSize)
        _GetMean_MMX(pSrc, nSrcStride, nSizeX, nSizeY, &nLocalSum, _GetMean4x4_MMX, 4);
    else if(64 == nPatchSize)
        _GetMean8x8_MMX(pSrc, nSrcStride, &nLocalSum);
    else if(128 == nPatchSize)
        _GetMean_MMX(pSrc, nSrcStride, nSizeX, nSizeY, &nLocalSum, _GetMean8x8_MMX, 8);
    else if(256 == nPatchSize)
        _GetMean16x16_MMX(pSrc, nSrcStride, &nLocalSum);
...
F32 Variance_MxN_MMX(IN const UINT8 *pSrc, IN const INT32 nSrcStride, IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSqSum, OUT UINT32 *pSum)
{
    const INT32             nPatchSize = nSizeX * nSizeY;
    UINT32                  nLocalSum = 0;
    
    if(16 == nPatchSize)
        _GetVar4x4_MMX(pSrc, nSrcStride, pSqSum, &nLocalSum);
    else if(32 == nPatchSize)
        _GetVariance_MMX(pSrc, nSrcStride, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetVar4x4_MMX, 4);
    else if(64 == nPatchSize)
        _GetVar8x8_MMX(pSrc, nSrcStride, pSqSum, &nLocalSum);
    else if(128 == nPatchSize)
        _GetVariance_MMX(pSrc, nSrcStride, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetVar8x8_MMX, 8);
    else if(256 == nPatchSize)
        _GetVar16x16_MMX(pSrc, nSrcStride, pSqSum, &nLocalSum);
                          ...
                          IN const INT32 nSizeX, IN const INT32 nSizeY, OUT UINT32 *pSqSum, OUT INT32 *pSum)
{
    ...
    if(16 == nPatchSize)
        _GetDiffVar4x4_MMX(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
    else if(32 == nPatchSize)
        _GetDiffVariance_MMX(pSrc0, nSrcStride0, pSrc1, nSrcStride1, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetDiffVar4x4_MMX, 4);
    else if(64 == nPatchSize)
        _GetDiffVar8x8_MMX(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
    else if(128 == nPatchSize)
        _GetDiffVariance_MMX(pSrc0, nSrcStride0, pSrc1, nSrcStride1, nSizeX, nSizeY, pSqSum, &nLocalSum, _GetDiffVar8x8_MMX, 8);
    else if(256 == nPatchSize)
        _GetDiffVar16x16_MMX(pSrc0, nSrcStride0, pSrc1, nSrcStride1, pSqSum, &nLocalSum);
